...
import com.faris.runningapp.databinding.FragmentStatisticsBinding
import com.faris.runningapp.databinding.MarkerViewBinding
import com.faris.runningapp.other.CustomMarkerView
...
class StatisticsFragment : Fragment() {
    ...
    private fun subscribeToObservers() {
        ...
        viewModel.runsSortedByDate.observe(viewLifecycleOwner) {
            it?.let {
                val allAvgSpeeds =
                    it.indices.map { i -> BarEntry(i.toFloat(), it[i].avgSpeedInKph) }
